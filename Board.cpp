...
inline void Board::fillTaboo(bool limitBlack, bool doubleThree, PlayerColor player)
{
...
inline void Board::fillPriority(PlayerColor player, const Options& options)
{
